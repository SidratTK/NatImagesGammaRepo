...
if isempty(modelParams)
    if strcmp(subjectName,'alpaH')
        ...
        modelParams.oriCenter = 109.3960; 
        modelParams.oriSpreadK = 0.8362;
    ...
    elseif strcmp(subjectName,'kesariH')
        modelParams.sfCenter = 3.0521; 
        modelParams.sfSigma = 1.0300; 
        modelParams.oriCenter =  23.9108;  
        modelParams.oriSpreadK = 0.1552; 
        modelParams.sizeSlope = 6.3396; 
        modelParams.sizeAtHalfMax = 0.3190; 
        modelParams.conSlope = 1.1180; 
        modelParams.conAtHalfMax = 32.1019;        
    end
end
...
if isempty(modelParams)
    if strcmp(subjectName,'alpaH')
        ...
        modelParams.sizeAtHalfMax = 1.2120; 
        modelParams.satSlope = 3.2922;
        modelParams.satAtHalfMax = 0.7477;
        modelParams.valSlope = 0.0807; 
        modelParams.valIntercept = 0.3472; 
    ...
    elseif strcmp(subjectName,'kesariH')
        ...
        modelParams.sizeAtHalfMax = 0.2257;
        modelParams.satSlope = 4.2867;
        modelParams.satAtHalfMax = 0.6463; 
        modelParams.valSlope = 2.7817e-04; 
        modelParams.valIntercept = 0.4753;    
    end
end
